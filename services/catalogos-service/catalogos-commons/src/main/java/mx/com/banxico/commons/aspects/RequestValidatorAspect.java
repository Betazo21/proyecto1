package mx.com.banxico.commons.aspects;

import mx.com.banxico.commons.exceptions.ForbiddenException;
import mx.com.banxico.commons.exceptions.NotFoundException;
import mx.com.banxico.commons.exceptions.ParametersException;
import mx.com.banxico.commons.exceptions.UnauthorizedException;
import mx.com.banxico.commons.to.ErrorTO;
...
public class RequestValidatorAspect {
    ...
    @Around(value = "execution(* mx.com.banxico.web.rest.*.*(..))  && args(..)")
